...
$$f_s(x) = \sum_{i=0}^\infty s_i x^i = s_0 + s_1x + s_2x^2 + s_3x^3 + s_4x^4 + \ldots = 2 + x + s_2x^2 + s_3x^3 + s_4x^4 + \ldots$$


$$xf_s(x) = \sum_{i=1}^\infty s_{i-1} x^i = 2x + x^2 + s_2x^3 + s_3x^4 + s_4x^5 + \ldots$$

$$x^2f_s(x) = \sum_{i=2}^\infty s_{i-2} x^i = 2x^2 + x^3 + s_2x^4 + s_3x^5 + s_4x^6 + \ldots$$

$$(1 - x - 6x^2)f_s(x) = \sum_{i=2}^\infty s_{i-2} x^i = (2 + x) + -2x + 
\sum_{i=2}^\infty (s_i - s_{i-1} - 6 s_i-2} x^i  = 2-x$$
