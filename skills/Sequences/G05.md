...
$$f_s(x) = \sum_{i=0}^\infty s_i x^i = 2 + x + s_2x^2 + s_3x^3 + s_4x^4 + \ldots$$


$$xf_s(x) = \sum_{i=1}^\infty s_{i-1} x^i = 0 + 2x + s_1x^2 + s_2x^3 + s_3x^4 + s_4x^5 + \ldots$$

$$x^2f_s(x) = \sum_{i=2}^\infty s_{i-2} x^i = 0 + 0x + s_0x^2 + s_1x^3 + s_2x^4 + s_3x^5 + s_4x^6 + \ldots$$
