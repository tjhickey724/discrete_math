...
In the graph below there are several cycles:
* b e c b
* b d e c b
* f f
* f h g f
...
Here is a directed graph representing an algorithm to print a sequence of numbers 

![forloopgraph](forloopgraph.png)
