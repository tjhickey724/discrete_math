...
The easiest way to do this is to model it on the way we construct Truth Tables, to see if something is a tautology.
| $x\in A$ | $x \in B$ | $A$ |  $\cap$| \overline B$| $\overline{A \cap \overline B}$ | ($\overline A$ | $\cup$|  B$) |
| ------- | ------- | ------- | ------- |------- | ------- | ------- | ------- | ------- | 
| T | T | T |F | F | T | T | T | T |
