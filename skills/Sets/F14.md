...
## Problem 1
Describe in English the set $A = {\bf N}\times \\{0,1\\}$ and list a few members of this set

**Answer:** $A$ is the set of pairs (n,b) where $n$ is a natural number and $b$ is a bit, e.g.
(7,0), (111,1) (14,1)

## Problem 2. 
Let $B=\\{0,1\\}$, list the elements of the set $C$ defined by $C=B\\times P(B)$
    where $P(B) = 2^B$ is the powerset of B.

**Answer**
$P(B)$ has $2^\vert B\vert= 2^2 = 4$ elements: $\\{\\}$, $\\{0\\}$, $\\{1\\}$, $\\{0,1\\}$, 
So $C$ contains 2*4 elements:
...
## Problem 3. 
List the elements of the set $D = \\{(a,s)\in C | a \in s\\}$

**Answer:**  Looking at the 8 elements of $(a,s)$ in $C$ we see there are just 4 where $a\in s$:
...
Calculate the sizes of the following sets, and write down a few of their elements.
1. ${\cal F}_2^3$   --> $2^3=8$
2. ${\cal F}_3 \times {\cal F}_5$ --> $3 * 5 = 15$
3. ${\cal P}({\cal F}_3)$ --> $2^3=8$
4. ${\cal F}_3\times {\cal P}({\cal F}_2)$ --> $3 * 2^2 = 12$
5. ${\cal P}({\cal F}_3)^2$ --> $(2^3)^2 = 8^2 = 64$ 
6. ${\cal P}({\cal P}({\cal F}_2))$ --> $2^{2^2} = 2^4 = 16$
