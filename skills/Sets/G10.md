...
## Problem 4
Let $S^-$ b the set of infinite sequences$(s_0,s_1,s_2,\ldots)$ of natural numbers which are non-increasing
(that is $s_i\ge s_{i+1}$ for all i). Prove that $S^-$ is countable. (Hint: look at the difference sequences
$s_i-s_{i+1}$)
